(function() {
  class FrontierSiliconExtension extends window.Extension {
    constructor() {
      super('frontier-silicon-adapter');
    ...
    show(context) {
      ...
      const description = document.getElementById(
        'extension-frontier-silicon-adapter-thing-description'
      );
