...
class SysmodeProperty extends Property {
  ...
  setCachedValue(value) {
    ...
    this.value = this.sysmodelist.find((x) => (x.label===value)).id;
    setTimeout((() => {
      switch (this.value) {
        ...
        case 'Spotify': // Spotify
          this.device.setVisibility(['netremote.sys.power', 'netremote.sys.mode', 'netremote.sys.audio.volume', 'muted', 'netremote.play.status', 'netremote.play.repeat', 'netremote.play.shuffle', 'info', 'cover', 'spotifyuser', 'previous', 'next']);
          break;
        case 'DMR': // DMR
        ...
        case 'DAB': // DAB
          ...
          break;
        case 'FM': // FM
          this.device.setVisibility(['netremote.sys.power', 'netremote.sys.mode', 'netremote.sys.audio.volume', 'muted', 'netremote.play.frequency', 'info', 'previous', 'next']);
          break;
